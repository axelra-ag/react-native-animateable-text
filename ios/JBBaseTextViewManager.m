...
#import "JBBaseTextViewManager.h"

@implementation JBBaseTextViewManager

RCT_EXPORT_MODULE(JBAnimatedBaseText)

- (UIView *)view
{
  RCTAssert(NO, @"The `-[JBBaseTextViewManager view]` property must be overridden in subclass.");
  return nil;
}

- (RCTShadowView *)shadowView
{
  RCTAssert(NO, @"The `-[JBBaseTextViewManager shadowView]` property must be overridden in subclass.");
  return nil;
}
