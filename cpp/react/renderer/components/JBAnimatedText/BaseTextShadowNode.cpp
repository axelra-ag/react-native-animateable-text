...
#include <react/renderer/components/JBAnimatedText/ParagraphShadowNode.h> // ADDED
...
void CBaseTextShadowNode::buildAttributedString( // EDITED
  ...
  // ADDED
  auto paragraphParentNode = dynamic_cast<const CParagraphShadowNode*>(&parentNode);
  if (paragraphParentNode != nullptr) {
