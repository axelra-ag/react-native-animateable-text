...
SharedDebugStringConvertibleList CParagraphProps::getDebugProps() const { // EDITED
...
ComponentName CParagraphProps::getDiffPropsImplementationTarget() const { // EDITED
  return "Paragraph";
}
