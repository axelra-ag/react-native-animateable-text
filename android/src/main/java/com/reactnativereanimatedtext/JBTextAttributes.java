...
public class JBTextAttributes {
  ...
  public JBTextAttributes() {}

  public JBTextAttributes applyChild(JBTextAttributes child) {
    JBTextAttributes result = new JBTextAttributes();
